...
//timing variables:
unsigned long previousSetupButtonTime;     //variable which stores the time between setupButton presses
unsigned long previousIncrementButtonTime; //variable which stores time between incrementButton presses
